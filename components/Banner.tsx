        ...
        <Row>
          <Col xs={12} lg={8}>
            <div
              className="card main"
              style={{
                backgroundImage: `url(${data[0].featuredImage.sourceUrl})`,
              }}
            >
            ...
            <Row>
              <Col xs={6} sm={6} lg={6}>
                <div
                  className="card"
                  style={{
                    backgroundImage: `url(${data[2].featuredImage.sourceUrl})`,
                  }}
                >
                  <div className="caption">
                    <h4>{data[2].title}</h4>
          ...
          <Col xs={12} lg={4}>
            <div
              ...
              style={{
                backgroundImage: `url(${data[1].featuredImage.sourceUrl})`,
              }}
            >
              <div className="caption">
                <h4>{data[1].title}</h4>
