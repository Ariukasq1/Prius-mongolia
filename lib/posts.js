...
import { QUERY_ALL_POSTS, QUERY_POSTS_BY_CATEGORY_SLUG, QUERY_POST_BY_SLUG, QUERY_POST_PER_PAGE } from '../data/posts';
...
export async function getPaginatedPosts(currentPage = 1, slug, postsPerQuery) {
  ...
  return {
    posts: sortedPosts.slice(offset, offset + postsPerQuery || postsPerPage),
    pagination: {
      currentPage: page,
      pagesCount,
    },
